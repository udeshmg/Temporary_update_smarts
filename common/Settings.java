...
public class Settings {
	...
	@Expose() public int extListenerUpdateInterval = 50; // lane update time interval in steps
	...
	@Expose() public String speedLimitController = "NORMAL";
	...
	public String getOutputPrefix (){
		if (!isExternalListenerUsed) return "noLA_"+String.valueOf(demandPerOneInterval)+"_"+speedLimitController+"_";
		else return externalListner+"_"+String.valueOf(demandPerOneInterval)+"_"+speedLimitController+"_";
	}
